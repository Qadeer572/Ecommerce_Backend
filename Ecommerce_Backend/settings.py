...
ALLOWED_HOSTS = ['miniamazone.herokuapp.com', '127.0.0.1', 'localhost']
...
INSTALLED_APPS = [
    ...
    'userAuth',  # Your custom app for user authentication
]
...
# Email settings (for account verification, password reset, etc.)
